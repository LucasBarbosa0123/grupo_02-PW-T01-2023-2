...
const constinueBtn = document.querySelector(".continue-btn");
...
function showQuestions(index){
    ...
    let optionTag = `<div class="option" onclick="optionSelected(this)" "><span>${questions[index].options[0]}</span></div>
